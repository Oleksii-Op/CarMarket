...
#
# e = ElectroCarAd(user_id=1, maker="test", model="test", price=1000,
#                  condition="test", fuel="test", power_output=100,
#                  gearbox="test", mileage=100, used=True,
#                  color="black", primary_registration=datetime.now(),
#                  manufactured_date=datetime.now(),
#                  engine_volume=1.6, average_consumption=5.5,
#                  vin_number="12345678test", hybrid=True, battery_capacity=100)
#
# c = MotorCarAd(user_id=1, maker="test", model="test", price=1000,
#                condition="test", fuel="test", power_output=100,
#                gearbox="test", mileage=100, used=True,
#                color="black", primary_registration=datetime.now(),
#                manufactured_date=datetime.now(),
...
#                vin_number="12345678test")
#
# m = MotorcycleAd(user_id=1, maker="test", model="test", price=1000,
#                  condition="test", fuel="test", power_output=100,
#                  gearbox="test", mileage=100, used=True,
#                  color="black", primary_registration=datetime.now(),
#                  manufactured_date=datetime.now(),
...
# print(t.__class__.__name__, t.model_dump())
# print('\n')
# print(e.__class__.__name__, e.model_dump())
# print('\n')
# print(c.__class__.__name__, c.model_dump())
# print('\n')
# print(m.__class__.__name__, m.model_dump())
